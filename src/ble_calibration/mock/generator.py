...
Examples:
  ...
  ble-calibration generate-mock
  ble-calibration generate-mock --output mock_data/session.jsonl --seed 7
"""
...
from ..domain.enums import DIRECTION_LABELS, NODE_ORDER
from ..domain.models import CanFrame

DIRECTIONS = list(DIRECTION_LABELS)

NODE_NAMES = [node.value for node in NODE_ORDER]
...
def generate_mock_session(config: MockConfig) -> Tuple[List[MockFrame], Dict[str, Any]]:
    ...
    manifest: Dict[str, Any] = {
        ...
        "generator": "ble_calibration.mock.generator",
